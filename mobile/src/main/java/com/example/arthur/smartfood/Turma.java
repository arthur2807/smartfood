...
public class Turma implements Serializable {
    ...
    public Turma(long cd_turma, String dc_turma, Produto cd_curso, String dc_horario_turma) {
        this(dc_turma,cd_curso, dc_horario_turma);
        this.cd_turma = cd_turma;
    }
    // Construtor usado no parser
    public Turma(String dc_turma, Produto cd_curso, String dc_horario_turma) {
